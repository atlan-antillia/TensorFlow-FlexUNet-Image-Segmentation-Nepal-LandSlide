...
class ImageMaskDatasetGenerator:
  ...
  def colorize_mask(self, mask):
    ...
    colorized[np.equal(mask, 255)] = (0, 128, 200)
    return colorized
...
if __name__ == "__main__":
  try:
     images_dir = "./Nepal-LandSlide-Dataset/images/"
     masks_dir  = "./Nepal-LandSlide-Dataset/masks/"
     master_dir = "./Nepal-LandSlide-master/"
